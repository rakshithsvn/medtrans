...
<section class="section">
    <div class="card shadow-sm p-4">
        <form action="{{ route('reports.vehicle') }}" method="POST">
            @csrf
        ...
        <div class="row mt-4">
            <div class="col-md-12 mb-3">
                <h5 class="text-white p-2 bg-secondary text-center">Vehicle Wise Report</h5>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-3 mb-3">
                        <div class="box shadow" style="background: linear-gradient(135deg, #e9f7fc, #d1eef9);">
                            <h5 class="text-secondary">Transport Trips</h5>
                            <p id="totalTrips" class="h3 fw-bold" style="color: #0082A3;">{{ $vehicleSummary['totalTransport'] }}</p>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="box shadow" style="background: linear-gradient(135deg, #e9f7fc, #d1eef9);">
                            <h5 class="text-secondary">Home Health Trips</h5>
                            <p id="totalKms" class="h3 fw-bold" style="color: #0082A3;">{{ $vehicleSummary['totalHomeHealth'] }} </p>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="box shadow" style="background: linear-gradient(135deg, #e9f7fc, #d1eef9);">
                            <h5 class="text-secondary">Ambulance Trips</h5>
                            <p id="totalKms" class="h3 fw-bold" style="color: #0082A3;">{{ $vehicleSummary['totalAmbulance'] }} </p>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="box shadow" style="background: linear-gradient(135deg, #e9f7fc, #d1eef9);">
                            <h5 class="text-secondary">Manual Trips</h5>
                            <p id="totalHours" class="h3 fw-bold" style="color: #0082A3;">{{ $vehicleSummary['totalManual'] }} </p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless report-table">
                                    <thead style="background-color:#396A7D !important; position: sticky; top: 0;">
                                        <tr>
                                            <th style="background-color:#396A7D !important; color: white; padding: 4px 8px;">Vehicle</th>
                ...
                <div class="cust-card box shadow p-2 pt-3">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="chart-container" id="fuelWiseGraph">
							...
							<div class="legend align-items-center mt-3" id="fuelWiseLegend"></div></div>
                ...
                <div class="cust-card box shadow p-2 pt-3">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="chart-container" id="jobWiseGraph">
							...
							<div class="legend align-items-center mt-3" id="jobWiseLegend"></div></div>
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-3">No job card found.</td>
                                </tr>
                                @endforelse
                                @endif
                            </tbody>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tableDataModalLabel">Vehicle Data</h5>
        ...
        <script>
            ...
            const fuelWiseChart = initBarChart('fuelWiseChart', fuelWiseReport, 'fuelWiseLegend', 'Litres');

            const jobWiseChart = initBarChart('jobWiseChart', jobWiseReport, 'jobWiseLegend', 'INR');
                    ...
                    options: {
                        ...
                        onClick: function(event, elements) {
                            if (elements.length) {
                                ...
                                const url = `get-vehicle-data/${measure}`;
