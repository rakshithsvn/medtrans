...
<section class="section">
    <div class="card shadow-sm p-4">
        <form action="{{ route('reports.department') }}" method="POST">
            @csrf
        ...
        <div class="row mt-4">
            <div class="col-md-12 mb-3">
                <h5 class="text-white p-2 bg-secondary text-center">Department Wise Report</h5>
            </div>
            <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless report-table">
                                    <thead style="background-color:#396A7D !important; position: sticky; top: 0;">
                                        <tr>
                                            <th style="background-color:#396A7D !important; color: white; padding: 4px 8px;">Department</th>
            ...
            <!-- <div class="col-md-6 mt-4">
                <div class="cust-card box shadow p-2 pt-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="text-dark mb-2" style="font-size: 1rem;">Vehicle Wise Report</h5>
                        <div class="btn-group">
                            <button class="btn btn-xs btn-primary toggle-btn active" data-target="vehicleWise" name="graph">Graph</button>
                            <button class="btn btn-xs btn-secondary toggle-btn" data-target="vehicleWise" name="table">Table</button>
                            <button class="btn btn-xs btn-success download-btn" data-target="vehicleWise">Download</button>
                        </div>
                    </div>
                    <div class="mt-3">
                        <div class="chart-container" id="vehicleWiseGraph">
                            <canvas id="vehicleWiseChart"></canvas>
                        </div>
                        <div class="legend align-items-center mt-3" id="vehicleWiseLegend"></div>
                        <div class="table-container d-none mt-2" id="vehicleWiseTable">
                            <div class="table-responsive">
                                <table class="table table-sm table-borderless report-table">
                                    <thead style="background-color:#396A7D !important; position: sticky; top: 0;">
                                        <tr>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="tableDataModalLabel">Department Data</h5>
        ...
        <script>
            ...
            const vehicleWiseReport = @json(@$vehicleWiseReport);
            ...
            // const vehicleWiseChart = initBarChart('vehicleWiseChart', vehicleWiseReport, [
                    ...
                    options: {
                        ...
                        onClick: function(event, elements) {
                            if (elements.length) {
                                ...
                                const url = `get-dept-data/${measure}`;
